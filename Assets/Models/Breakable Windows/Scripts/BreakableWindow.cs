        ...
        if (isBroken == false)
        {
            if (allreadyCalculated == true)
            {
                ...
                if (addTorques)
                {
                    ...
                    {
                        splinters[i].AddComponent<Rigidbody>().AddTorque(new Vector3(Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50));
                    }
                }
            }
            else
